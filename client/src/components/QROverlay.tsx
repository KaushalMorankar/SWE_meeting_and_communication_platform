...
const QROverlay: FC<QROverlayProps> = ({ onClose, meetingTitle }) => {
  return (
    <div className="qr-overlay" onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ textAlign: 'center', color: 'white' }}>
          ...
          <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Attendees can scan this code to mark attendance</p>
        </div>

        <button className="btn-icon" onClick={onClose} style={{ position: 'absolute', top: '16px', right: '16px', color: 'white' }}>
