                ...
                <div className="transcript-list" ref={listRef}>
                    ...
                    {transcripts.length === 0 && (
                        <div className="empty-state">
                            <p style={{ fontSize: '14px' }}>Transcription is not enabled</p>
                            <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Live transcript will appear here when this feature is available.</p>
                        </div>
                    )}
                </div>
                </div>
